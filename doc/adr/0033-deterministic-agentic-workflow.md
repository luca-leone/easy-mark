...
Governance validation must assert the presence of the workflow, deterministic path contract, skills, required loops, and separation between `.agents/skills/` and `.codex/agents/`.
